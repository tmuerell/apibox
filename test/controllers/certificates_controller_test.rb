...
class CertificatesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create certificate" do
    assert_difference('Certificate.count') do
      post certificates_url, params: { certificate: { cert: @certificate.cert, key: @certificate.key, name: @certificate.name } }
    end
  ...
  test "should update certificate" do
    patch certificate_url(@certificate), params: { certificate: { cert: @certificate.cert, key: @certificate.key, name: @certificate.name } }
